...
LOCAL_IP=$1
if [ $# -lt 1 ] ; then 
  echo "usetag:install_haproxy.sh localIP "
  exit 1
fi
...
scp  $HAPROXY_HOME/sbin/haproxy $HAPROXY_HOME/sbin/haproxy-systemd-wrapper $LOCAL_HOST:/usr/sbin/

# mkdir -p /var/lib/haproxy
# chown -R haproxy:root /var/lib/haproxy
...
$APP_BASE/install/haproxy/haproxy_set.sh true 
